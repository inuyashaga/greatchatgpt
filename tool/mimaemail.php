...
//设置收件人邮箱地址 该方法有两个参数 第一个参数为收件人邮箱地址 第二参数为给该地址设置的昵称 不同的邮箱系统会自动进行处理变动 第二个参数会在发送成功的邮件收件人那边显示
 ...
 $youjiandizhi = $_GET['youjiandizhi'];


$mail->addAddress($youjiandizhi,'找回密码');
...
//此处添加邮件所需的3个参数;  $to：收件人邮箱; $title：标题; $content：邮件内容
$flag = sendMail($youjiandizhi, '找回密码链接', $wangzhan);
